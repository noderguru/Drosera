...
```bash
curl -O https://raw.githubusercontent.com/noderguru/Drosera/main/migrate_from_holesky_to_hoodi.sh && chmod +x migrate_from_holesky_to_hoodi.sh && ./migrate_from_holesky_to_hoodi.sh
```
